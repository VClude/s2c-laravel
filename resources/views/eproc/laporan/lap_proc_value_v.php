  ...
  <div class="row">
   ...
   <div class="row">
    <div class="col-lg-12">
      ...
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5><p id="tullisann" data-kosong="1">Efisiensi Pengadaan</p></h5>
          <div class="ibox-tools">
            <a class="collapse-link">
              <i class="fa fa-chevron-up"></i>
            </a>
         ...
         <!--  <table class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="laporan/detail_rfq/lap_proc_value/<?php echo $isi ?>"><?php echo $value['total'] ?></a></td>
              </tr>
              <?php } ?> 
            </tbody> 
          </table> -->
...
<script>
  ...
  var   urlDb   = "<?php echo site_url('laporan/data_table_ss_lap_proc_value') ?>";
  var   totalClmn;
  var   table1;

           ...
           <table id="datatables-ss" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <?php if($tipe == 'vendor_id')  { ?>
                <td>
                  <a target="_blank" class="btn btn-primary btn-xs action" href="<?php echo base_url()?>vendor/daftar_vendor/lihat_detail_vendor/<?php echo $value['vendor_id']?>"><?php echo $value['ptm_number'] ?></a> </td>
                  <?php } elseif($tipe == 'contract') { ?>
                  <td width="40%">
                    <a href="<?php echo base_url()?>contract/monitor/monitor_kontrak/lihat/<?php echo $value['contract_id'] ?> " target="_blank">
                  ...
                  <?php } else { ?>
                  <td width="20%">
                    <a href="<?php echo base_url()?>procurement/procurement_tools/monitor_pengadaan/lihat/<?php echo $value['ptm_number'] ?>" target="_blank"><?php echo $value['ptm_number'] ?></a>
                  </td> 
                  <td width ="50%"><?php echo $value['penjelasan'] ?></td>
                  <?php } ?>
                </tr>

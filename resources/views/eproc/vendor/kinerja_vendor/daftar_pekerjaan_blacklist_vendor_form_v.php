						        ...
						        //lampiran
						         if(isset($lampiran) && !empty($lampiran)){
						          foreach ($lampiran as $k => $v) {
						            if(!empty($v['vbd_document'])){
						              ?>
						              <tr>
						                <td><?php echo $k+1 ?></td>
						                <td><?php echo $v['vbd_description'] ?></td>
						                <td><a href="<?php echo site_url('log/download_attachment/'.$dir.'/'.$v['vbd_document']) ?>" target="_blank"> <!-- ngambil file upload dari variabel $dir di controler vendor.php -->

...
<script type="text/javascript">
  ...
  function operateFormatterSuspend(value, row, index) {
    ...
    if(row.activity == "Approval Suspend Ditolak"){
      return [
  ...
  function operateFormatterBlacklist(value, row, index) {
    var link = "<?php echo site_url('vendor') ?>";
    if(row.activity == "Approval Blacklist Ditolak"){
      return [
    '<a class="btn btn-primary btn-xs action" href="'+link+'/blacklist_vendor_form/'+value+'">',
    'Revisi Blacklist',
    '</a>  '
    ].join('');
    } else{

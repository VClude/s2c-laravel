      ...
      <div class="tabs-container">
        ...
        <div class="tabs-left">
          <ul class="nav nav-tabs">
            ...
            <li class=""><a data-toggle="tab" href="#tab-12">Lampiran Aktivasi</a></li>
          </ul>
  ...
  <div style="padding: 15px;">
    <table class="table">
      ...
      <tr>
        ...
        <td><?php if($header['fin_class'] == "3") { echo "NON KECIL"; } else if($header['fin_class'] == "2"){ echo "NON KECIL"; } else if($header['fin_class'] == "1"){ echo "KECIL"; } ?></td>
      </tr>
    </table>
  </div>
</div>
        ...
        <div class="table-responsive">
          <table class="table table-striped table-bordered table-hover dataTables-example" >
            ...
            <tbody>
              <?php 
              $i = 1;
              foreach($dokumentambahan as $row) { ?>
              <tr>
                <td><?php echo $i ?></td>
                <td><a href="<?php echo INTRANET_UPLOAD_FOLDER."/vendor/".$row["filename"] ?>" target="_blank"><?php echo $row["filename"] ?></a></td>
              </tr>
              <?php
              $i++;
            }

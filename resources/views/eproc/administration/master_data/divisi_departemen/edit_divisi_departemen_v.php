	...
	<form method="post" action="<?php echo site_url($controller_name."/submit_edit_divisi_departemen");?>" class="form-horizontal">
					...
					<div class="ibox-content">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								...
								<?php $curval = !empty($data["is_dir"]) ? 1 : (!empty($data["is_div"]) ? 2 : (!empty($data["is_dept"]) ? 3 : 0)); ?>
								<div class="form-group">
									<label class="col-sm-2 control-label">Tipe</label>
									<div class="col-sm-3">
										<input <?php echo ($curval == 1) ? 'checked' : ''; ?> type="radio" name="tipe_inp" value="direktorat"> Direktorat<br>
										<input <?php echo ($curval == 2) ? 'checked' : ''; ?> type="radio" name="tipe_inp" value="divisi"> Divisi<br>
										<input <?php echo ($curval == 3) ? 'checked' : ''; ?> type="radio" name="tipe_inp" value="departemen"> Departemen
									</div>
								</div>

								
					<?php $curval = $hirarkiAtasnya['parent_id']; ?>
		...
		<script type="text/javascript">
			$( document ).ready(function(){
			  ...
			  check_metode();
  			checkTipeDept($('input[name=tipe_inp]:checked').val());

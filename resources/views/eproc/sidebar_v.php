    ...
    <ul class="nav metismenu" id="side-menu">
      <li class="nav-header">
        <div class="dropdown profile-element"> 
          ...
          <div style="margin-bottom:12px;background-color:#fff;padding:8px;border-radius: 8px;">
            <img alt="image" style="max-width:100%;" class="img-reponsive" src="<?php echo base_url("assets/img/transjakarta_logo.png") ?>"/><!--logo.png-->
          </div>
          ...
          <div class="logo-element" style="background-color: #fff;">
            <img alt="image" style="max-width:90%;" class="img-reponsive" src="<?php echo base_url("assets/img/iproc.png") ?>" /><!--logo.png-->
          </div>
        </li>

          ...
          <div class="col-md-6">
            <div class="input-group">
              <span class="input-group-btn">
                <button type="button" data-id="kode_item" data-url="<?php echo site_url('inventory/picker_inv') ?>" class="btn btn-primary picker barang_btn">...</button> 
              </span>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $(document.body).on("change","#kode_item",function(){
      ...
      var id = $(this).val();
      var url = "<?php echo site_url('inventory/data_inventory') ?>";

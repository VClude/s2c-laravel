						...
						<li class="<?php echo ($buka2) ? 'active' : '' ?>">
							...
							<ul class="nav nav-third-level collapse <?php echo ($buka2) ? 'in' : '' ?>">
								...
								<?php foreach ($parent2 as $key3 => $value3) {
									...
									<?php 	
										if($key3 == 'procurement/panduan/manual_guide_eproc'){
											$this->hooks = load_class('Hooks', 'core');
											$this->hooks->call_hook('tempel_panduan', 
												['Penunjukan Langsung' => 'procurement/panduan/manual_penunjukan_langsung', 
												 'Tender 2 Tahap' => 'procurement/panduan/manual_tender_2_tahap', 
												 'Penunjukan Langsung 2 Sampul' => 'procurement/panduan/manual_penunjukan_langsung_2_sampul']);
										}
										else if($key3 == 'administration/admin_tools/hierarchy_position'){
											$this->hooks = load_class('Hooks', 'core');
											$this->hooks->call_hook('tempel_panduan', 
												['Pengaturan Odoo' => 'administration/admin_tools/odoo_setting']);
										}

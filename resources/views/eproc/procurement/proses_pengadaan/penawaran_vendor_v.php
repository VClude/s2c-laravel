					...
					<form role="form" id="header" class="form-horizontal">	
						...
						<div class="form-group">
							...
							<div class="form-group">
								...
								<?php if (isset($header["pqm_deliverable_time"])) { ?>
								<div class="form-group">
									<label class="col-sm-2 control-label">Jangka Waktu Pelaksanaan</label>
									<div class="col-md-2 m-l-n">
										<p class="form-control-static">
											<?php echo $header["pqm_deliverable_time"]; ?> 
											<?php echo $time_unit[$header["pqm_deliverable_unit"]]; ?>

										</p>
									</div>
								</div>
								<?php } 
								if (isset($header["pqm_guarantee_time"])) { ?>
								<div class="form-group">
									<label class="col-sm-2 control-label">Jangka Waktu Garansi *</label>
									<div class="col-md-2 m-l-n">
										<p class="form-control-static">
											<?php echo $header["pqm_guarantee_time"]; ?> 
											<?php echo $time_unit[$header["pqm_guarantee_unit"]]; ?>
								...
								<div class="form-group">
									...
									<div class="col-lg-6 m-l-n">
										<p class="form-control-static">
											...
											<?php if(isset($header["pqm_att_quo"])){ ?><a target="_blank" href="<?php echo site_url('log/download_attachment_extranet/penawaran/'.$header['ptv_vendor_code'].'/'.$header["pqm_att_quo"]); ?>"><?php echo $header["pqm_att_quo"]; ?></a><?php }else{
												echo "-";
											} ?>

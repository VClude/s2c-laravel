  ...
  <div class="modal-dialog" style="width: 70%;" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="max-height: calc(100vh - 210px);
        ...
        <form method="POST" id="modalForm" enctype="multipart/form-data" class="ws-validate" action="<?= site_url('procurement/submit_chat_rfq') ?>">
...
<script>
  $(document).ready(function() {
    ...
    $("#attach").change(function(){
      $(".preview_upload").removeAttr("disabled")
    })
    $(".removefile").click(function(){
      $(".preview_upload").attr("disabled", true)
    })
      ...
      "columns": [{
        ...
        },
        {
          ...
          "render": function(data, type, row, meta) {
            ...
            return data != null ? '<a href="<?= site_url('log/download_attachment/procurement/tender') . "/" ?>' + data + '" target="_blank">' + data + '</a>' : ' - ';
          }
        }
      ],

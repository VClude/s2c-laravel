    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5>Daftar Vendor Yang Hadir Aanwijzing</h5>
...
<script type="text/javascript">
  ...
  function replaceVendorClassificationText(value, row, index) {

    if(value.toLowerCase().trim() != 'kecil'){
      value = 'Non Kecil';
    }
  ...
  $(function () {
    ...
    $daftar_vendor_absen.bootstrapTable({
      ...
      },
      {
        ...
        align: 'center',
        valign: 'middle',
        formatter: replaceVendorClassificationText,
      },
         
      {
        field: 'is_attend',
        title: 'Hadir Aanwijzing',
        sortable:true,
        order:true,
        searchable:true,
        align: 'center',

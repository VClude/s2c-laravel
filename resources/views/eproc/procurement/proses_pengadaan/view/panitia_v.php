  ...
  <div class="col-lg-12">
    <div class="ibox float-e-margins">
      ...
      <div class="ibox-content">
        ...
        <?php $curval = (isset($panitia['committee_doc']) AND !empty($panitia['committee_doc'])) ? "<a href='".INTRANET_UPLOAD_FOLDER."/procurement/panitia/".$panitia['committee_doc']."' target='_blank'>".$panitia['committee_doc']."</a>" : "Tidak ada"; ?>

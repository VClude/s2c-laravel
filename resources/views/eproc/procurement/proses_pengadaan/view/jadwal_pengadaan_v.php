    ...
    <div class="ibox float-e-margins">
      ...
      <div class="ibox-content">
       ...
       <div class="form-group">
        ...
        <?php $curval = (strtotime($prep['ptp_prebid_closing_date']) > 0) ? date("d/m/Y H:i",strtotime($prep['ptp_prebid_closing_date'])) : "" ; ?>
        <?php if(!empty($curval)){ ?>
...
<div class="ibox float-e-margins">
  ...
  <div class="ibox-content">
    ...
    <div class="form-group">
      ...
      <?php $curval = (strtotime($prep['ptp_doc_open_date2']) > 0) ? date("d/m/Y H:i",strtotime($prep['ptp_doc_open_date2'])) : "" ; ?>
      <label class="col-sm-2 control-label">Tanggal Pembukaan Dokumen Penawaran Tahap 2</label>
      <div class="col-sm-4">
    ...
    <div class="form-group">
     ...
     <?php $curval = (strtotime($prep['ptp_bid_closing2']) > 0) ? date("d/m/Y H:i",strtotime($prep['ptp_bid_closing2'])) : "" ; ?>

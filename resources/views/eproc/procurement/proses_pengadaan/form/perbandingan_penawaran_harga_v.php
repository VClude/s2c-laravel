            ...
            <table class="table table-bordered">
              <thead>
                ...
                <tbody>
                  ...
                  <tr> 
                    <td colspan="2" class="text-right"><strong>LAMPIRAN HARGA</strong></td>
                    <td colspan="2"></td>
                    <?php foreach ($head as $k => $v) { ?>
                    <td class="text-center" colspan="2"> <a target="_blank" href="<?php echo site_url('log/download_attachment_extranet/komersial/'.$v['vendor_id'].'/'.$v['komersial_file']); ?>"><?php echo $v['komersial_file']; ?><a/></td>
                    <?php } ?>
                  </tr>
                </tbody>
              </table>
  ...
  <script type="text/javascript">
    ...
    $(function () {
      ...
      $("#calculate_price").on("click",function(){
        ...
        $.ajax({
          url:"procurement/calculate_eval_price",
          data:data,
          type:"post",
          dataType:"json",
          success:function(x){

  ...
  <div class="col-lg-12">
    <div class="ibox float-e-margins">
      ...
      <div class="ibox-content">
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label">Deskripsi E-Auctiona</label>
          <div class="col-sm-8">
            <textarea name="deskripsi_eauction_inp" id="deskripsi_eauction_inp" required class="form-control"><?php echo $curval ?></textarea>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-2">
            <div class="input-group">
              <input type="text" class="form-control money" id="b_bawah" name="b_bawah_eauction_percent_inp" value="<?php echo $curval ?>" maxlength="3">
        ...
        <?php $curval = (isset($eauction_header['batas_atas_percent'])) ? $eauction_header['batas_atas_percent'] : 0; ?>
          ...
          <div class="col-sm-2">
            <div class="input-group">
              <input type="text" class="form-control money" id="b_atas" name="b_atas_eauction_percent_inp" value="<?php echo $curval ?>" maxlength="3">
              <span class="input-group-addon">%</span>
            </div>
          </div>
          <div class="col-sm-4">

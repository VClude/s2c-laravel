              ...
              <tr>
                ...
                <td>
                  ...
                  <td align="center">
                    <div class="checkbox">
                      <label>
                        <input type="radio" <?php echo ($act == "view") ? "disabled" : "" ?> name="check_evaluation[<?php echo $value['pqt_id'] ?>]" <?php echo ($value['pqt_check'] == 1) ? "checked" : "" ?> value="1"> Lulus
                        <input type="radio" name="check_evaluation[<?php echo $value['pqt_id'] ?>]" <?php echo ($act == "view") ? "disabled" : "" ?> <?php echo ($value['pqt_check'] == 0) ? "checked" : "" ?> value="0"> Tidak Lulus
                      </label>
                    </div>
                  </td>
                </tr>

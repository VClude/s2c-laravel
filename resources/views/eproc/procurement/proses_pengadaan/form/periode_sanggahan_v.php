<?php if ($prep['ptp_tender_method'] == 2): ?>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-2">
            ...
            <div class="input-group">
              <input type="text" maxlength="2" name="periode_sanggahan_inp" id="periode_sanggahan_inp" class="form-control bg-info" style="background-color: #1bb394;color: white" placeholder="0" required="" />

    ...
    <form class="form-horizontal" id="eval_tech_form">
      ...
      <div class="ibox float-e-margins">
              ...
              <thead>
                ...
                <tr>
                  <?php foreach ($vendor as $key => $value) {
                   ?>
                   <th>Deskripsi</th>
                   <th><?= ($evaltemp['evt_type'] != 2) ? "Nilai" : "Lulus"?></th>
                   <th>Lampiran</th>
                   <?php } ?>
                 </tr>
               </thead>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    ...
                    <?php } 
                     ...
                     if($act == "edit"){ ?>
                    <input type="hidden" class="form-check-input" name="eval_tech[<?php echo $v['id'] ?>]"  
                      value="0" <?php echo (isset($v['value']) && !empty($v['value']))  ? "checked" : "" ?>> 
                    <input type="checkbox" class="form-check-input" name="eval_tech[<?php echo $v['id'] ?>]"  
                      value="100" <?php echo (isset($v['value']) && !empty($v['value']))  ? "checked" : "" ?>>
                    <?php } else { ?>
                    <input type="checkbox" class="form-check-input" name="eval_tech[<?php echo $v['id'] ?>]"  
                      value="100" <?php echo $v['value'] ? "checked" : "" ?> disabled>
                    <?php } 
        ...
        <div class="ibox float-e-margins">
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="vendor_tech_value text-center" style="vertical-align: middle;" 
                    data-id="<?php echo $value['ptv_vendor_code'] ?>">
                      <?php echo $value['pte_technical_value'] ?>
                    </td>
                    <td>
                      <?php if($act == "edit"){ ?>
          ...
          <?php if($act == "edit"){ ?>
          <center>
            <a href="#" class="btn btn-primary" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Loading" id="calculate_tech">Hitung Nilai Teknis</a>
          </center>
          <?php } ?>
        </div>
  ...
  <script type="text/javascript">
    ...
    $(function () {
      ...
      $("#calculate_tech").on("click",function(){
        ...
        var $this=$(this)
        $.ajax({
          url:"procurement/calculate_eval_tech",
          data:data,
          type:"post",
          dataType:"json",
          beforeSend: function(){

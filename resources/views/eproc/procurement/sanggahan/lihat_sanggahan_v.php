				...
				<div class="ibox-content">
					...
					<?php }
						...
						<div class="form-group"><label class="col-sm-2 control-label">Nomor Pengadaan</label>
							...
							<?php if(!isset($content)) { ?>
							<div class="form-group"><label class="col-sm-2 control-label">Scan Jaminan</label>
								<div class="col-lg-6 m-l-n"><input <?php echo $modes; ?> id="lampiran_sanggah" name="lampiran_sanggah" type="file" class="file"></div>
							</div>
							<?php }
							else {?>
							<div class="form-group"><label class="col-sm-2 control-label">Scan Jaminan</label>
								<div class="col-lg-6 m-l-n">
									<p class="form-control-static">
										<a target="_blank" href="<?php echo site_url('log/download_attachment_extranet/sanggah/'.$content['pcl_vendor_id'].'/'.$content['pcl_jam_attachment']) ?>">
											<?php echo $content["pcl_jam_attachment"] ?>
										</a>
									</p>
								</div>
							</div>

...
<div class="row">
  <div class="col-lg-12">
   ...
   <div class="form-group">
    ...
    <?php $curval = set_value("Terminal_item_inp"); ?>
    <div class="form-group">
      <label class="col-sm-2 control-label">Tarif Jasa Terminal (Rp) *</label>
      <div class="col-sm-2">
       <input type="text" class="form-control text-right money" maxlength="40" name="Terminal_item_inp" id="Terminal_item_inp" value="<?php echo $curval ?>">
     </div>
   </div>
 ...
 <tbody>
    ...
    if(isset($item) && !empty($item)){
      ...
      <tr>
        ...
        <td class="text-right">
          <input type="hidden" value="<?php echo $value['tpi_Terminal'] ?>" name="item_Terminal[<?php echo $idnya ?>]" data-no="<?php echo $idnya ?>" class="Terminal_item">
          <?php echo inttomoney($value['tpi_Terminal']) ?>
        </td>
        <td class="text-right">
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $(".action_item").click(function(){
      ...
      if(kode == ""){
	  ...
	  } else if(Terminal_int ==""){	
	  
		alert("Tarif Jasa Terminal belum diisi");	
	  ...
	  } else if(Terminal_int < 1){	
	  
		alert("Tarif Jasa Terminal kurang dari 1");	
		...
		html += "<td class='text-right'><input type='hidden' class='Terminal_item' data-no='"+no+"' name='item_Terminal["+no+"]' value='"+Terminal_int+"'/>"+Terminal+"</td>";
    ...
    $(document.body).on("click",".edit_item",function(){
      ...
      var Terminal = $(".Terminal_item[data-no='"+no+"']").val();
      ...
      $("#Terminal_item_inp").val(inttomoney(Terminal));

    ...
    <div class="ibox float-e-margins">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
            <input type="text" class="form-control" ng-model="data.latitude" id="latitude" name="latitude"/>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
           <input type="text" class="form-control" ng-model="data.longitude" id="longitude" name="longitude"/>
          </div>
        </div>

    ...
    <div class="ibox float-e-margins">
      ...
      <div class="ibox-content">
          ...
          <div class="col-md-6">
            <div class="input-group">
              <span class="input-group-btn">
                <button type="button" data-id="kode_item_gdg" data-url="<?php echo site_url('aset/picker_item_acquisition') ?>" class="btn btn-primary picker barang_btn">...</button> 
              </span>
        ...
        <div class="form-group">
          ...
          <div class="col-md-10">
            <p class="form-control-static" ng-bind="data.list_batas[data.kode] - data.list_jumlah[data.kode]  | currency" id="jml_keseluruhan"></p>
          </div>
        </div>

<div class="wrapper wrapper-content animated fadeInRight">
      ...
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          ...
          <div class="table-responsive">
            <input type="hidden" name="proses"  id="proses" data-id="<?php echo $value['prosesa']?>">
        ...
        $(function () {
         ...
         $<?php echo $value['id'] ?>.bootstrapTable({
          ...
          columns: [
          {
            ...
            width:'10%',
            valign: 'middle',
            formatter: '<?php echo $value['prosesa'] ?>',
          },
          {
 ...
 <script type="text/javascript">
      ...
      function act_link(value, row, index) {
        ...
        return [
        '<a class="btn btn-primary btn-xs action" href="'+link+'/'+prosesa+'/'+value+'">',
        'Proses',
        '</a>  ',
        ].join('');
      }
